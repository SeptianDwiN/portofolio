<template>
    ...
    <section class="mb-32 text-center lg:text-left">
     ...
     <u id="project"><center>Project :</center></u>
    </h5>
    <br>
   <div class="grid gap-x-6 lg:grid-cols-1 pl-20 pr-20">
...
<div class="mb-12 lg:mb-0">
  <div class="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20 bg-[50%]" data-te-ripple-init data-te-ripple-color="light">
    <img src="../assets/foto.JPG" class="w-full"  />
    <a href="#!">
      <div
  ...
  <h5 class="mb-4 text-lg font-bold"></h5>
        ...
        <p class="text-neutral-500 dark:text-neutral-300">
          Website ini berunjuk pada belanja online 
        </p>
  </div>
  </div>
</section>
